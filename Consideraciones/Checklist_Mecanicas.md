...
- **Revamp de caravanas** (carros, animales de arrastre, escuadrones de escolta sin héroe, cap por Mercado, planificación horaria).
...
- 🔶 **Revamp de caravanas**: la caravana se arma con **tres partes** (carros / animales de carga / **escuadrones de escolta sin héroe**, estos según nivel de asentamiento y Mercado), más carro básico al construir el Mercado, animales comprables o criados (bueyes / caballos / camellos), tipos de carro fabricables en Carpintería, cap de caravanas activas por Mercado, velocidad igual a la del carro más lento, tiempo de preparación según nº de carros, interfaz de preparación y planificación horaria, y visibilidad en el mapa según el tamaño de la caravana — **`código: ✘`**. Lo que hay hoy: capacidad y velocidad fijas por categoría, cupo ampliable por política (`cupo_caravana_extra`) y cooldown de creación. Ficha en `Docs/Mecanicas a desarrollar.md` §8.
