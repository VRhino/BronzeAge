...
## Héroe bot
Héroe de una Facción NPC, manejado por la IA del juego. Combate contra los héroes humanos en las partidas de Unity; NPC contra NPC se resuelve con números (Doc 5.15.6).
