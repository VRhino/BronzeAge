...
> **44-62 ms**. **Ninguna decisión de este documento cambia** —salen todas reforzadas, que es justo por lo
...
2026-09-05 y tras optimizar, **44-62 ms**. Los 500 asentamientos son un
...
> **Cifras de agosto de 2026.** El ABSOLUTO ya no vale: el tick completo a 100 asentamientos son **61,9 ms**
> medidos el 2026-09-05/06, tras engordar con trazado urbano/murallas/ejércitos/niebla y adelgazar después 7,6×
...
**61,9 ms** (medido 2026-09-05/06; la cifra de 78,5 ms que traía esta línea era una extrapolación de agosto).
